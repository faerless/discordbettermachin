...
#app-mount .wrapper-3vR61M,									/* chat					messages laoding					*/
...
.connection-1fbD7X[style*="background-color: rgb(25, 23, 23)"] {
	background-color: rgba(25, 23, 23, 0.8) !important;
}
